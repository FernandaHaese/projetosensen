        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-6">
            <a
              ...
              aria-label="Facebook"
            >
              <svg className="w-[10px] h-[18px]" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            >
              <svg className="w-[18px] h-[16px]" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M13.9378 0H16.64L10.7378 6.79111L17.7067 16H12.2311L7.96444 10.4178L3.05778 16H0.355556L6.68444 8.74667L0 0H5.61778L9.49333 5.12L13.9378 0ZM12.9778 14.3644H14.4711L4.8 1.52889H3.16444L12.9778 14.3644Z" fill="currentColor"/>
              </svg>
            </a>
            <a
            ...
            >
              <svg className="w-[16px] h-[16px]" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_steam)">
                  <path d="M7.99094 0C3.76897 0 0.326161 3.23616 0 7.35819L4.29445 9.12994C4.65685 8.87684 5.09173 8.7322 5.56285 8.7322C5.59909 8.7322 5.65345 8.7322 5.68969 8.7322L7.61042 5.98418C7.61042 5.9661 7.61042 5.9661 7.61042 5.94802C7.61042 4.28475 8.96942 2.92881 10.6365 2.92881C12.3035 2.92881 13.6625 4.28475 13.6625 5.94802C13.6625 7.6113 12.3035 8.96723 10.6365 8.96723C10.6183 8.96723 10.5821 8.96723 10.564 8.96723L7.84598 10.9017C7.84598 10.9379 7.84598 10.974 7.84598 11.0102C7.84598 12.2576 6.83126 13.2701 5.58097 13.2701C4.47565 13.2701 3.56965 12.4927 3.35221 11.4441L0.271801 10.1785C1.21404 13.5412 4.31257 16 7.99094 16C12.4122 16 16 12.4203 16 8.00904C16 3.57966 12.4122 0 7.99094 0Z" fill="currentColor"/>
                  <path d="M5.01925 12.131L4.04077 11.7333C4.22197 12.0949 4.51189 12.4022 4.91053 12.5649C5.7803 12.9265 6.7769 12.5107 7.1393 11.6429C7.3205 11.2271 7.3205 10.757 7.1393 10.3412C6.9581 9.92537 6.63194 9.59995 6.21518 9.41916C5.79842 9.23837 5.34541 9.25645 4.96489 9.40108L5.97962 9.8169C6.61382 10.0881 6.92186 10.8112 6.65006 11.444C6.39638 12.0949 5.65346 12.4022 5.01925 12.131Z" fill="currentColor"/>
                  <path d="M12.6478 5.92988C12.6478 4.82705 11.7418 3.9231 10.6364 3.9231C9.53112 3.9231 8.62512 4.82705 8.62512 5.92988C8.62512 7.0327 9.53112 7.93666 10.6364 7.93666C11.7418 7.93666 12.6478 7.05078 12.6478 5.92988ZM9.11436 5.92988C9.11436 5.09824 9.78481 4.42931 10.6364 4.42931C11.4881 4.42931 12.1585 5.09824 12.1585 5.92988C12.1585 6.76151 11.4881 7.43044 10.6364 7.43044C9.78481 7.43044 9.11436 6.76151 9.11436 5.92988Z" fill="currentColor"/>
                </g>
                <defs>
            ...
            >
              <svg className="w-[17px] h-[14px]" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M15.5714 4.27273C15.5714 3.9834 15.4533 3.70592 15.2431 3.50134C15.0329 3.29675 14.7478 3.18182 14.4505 3.18182H7.16484L5.81978 1.43636C5.71537 1.30088 5.57999 1.19091 5.42435 1.11517C5.26871 1.03943 5.09709 1 4.92308 1H2.12088C1.8236 1 1.5385 1.11493 1.3283 1.31952C1.11809 1.5241 1 1.80158 1 2.09091V11.9091C1 12.1984 1.11809 12.4759 1.3283 12.6805C1.5385 12.8851 1.8236 13 2.12088 13H14.4505C14.7478 13 15.0329 12.8851 15.2431 12.6805C15.4533 12.4759 15.5714 12.1984 15.5714 11.9091V4.27273Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </a>
          </div>
        </div>
